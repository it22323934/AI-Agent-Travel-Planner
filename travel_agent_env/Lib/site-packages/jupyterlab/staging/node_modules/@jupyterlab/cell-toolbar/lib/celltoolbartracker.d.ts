...
export declare class CellToolbarTracker implements IDisposable {
     ...
     */
    constructor(panel: NotebookPanel, toolbar?: IObservableList<ToolbarRegistry.IToolbarItem>, toolbarFactory?: (widget: Cell) => IObservableList<ToolbarRegistry.IToolbarItem>, translator?: ITranslator);
    /**
...
export declare class CellBarExtension implements DocumentRegistry.WidgetExtension {
    ...
    constructor(commands: CommandRegistry, toolbarFactory?: (widget: Widget, commandArgs?: Record<string, any>) => IObservableList<ToolbarRegistry.IToolbarItem>);
    protected createItemFactory(commands: CommandRegistry): (widgetFactory: string, widget: Widget, toolbarItem: ToolbarRegistry.IWidget) => Widget;
    protected get defaultToolbarFactory(): (widget: Widget, commandArgs?: Record<string, any>) => IObservableList<ToolbarRegistry.IToolbarItem>;
